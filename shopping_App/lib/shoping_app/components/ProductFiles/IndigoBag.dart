...
class IndegoBag extends StatefulWidget {
  const IndegoBag({super.key});

  @override
  State<IndegoBag> createState() => _IndegoBagState();
}

class _IndegoBagState extends State<IndegoBag> with  SingleTickerProviderStateMixin{
