...
class Blue2Bag extends StatefulWidget {
  const Blue2Bag({super.key});

  @override
  State<Blue2Bag> createState() => _Blue2BagState();
}

class _Blue2BagState extends State<Blue2Bag> with  SingleTickerProviderStateMixin{
