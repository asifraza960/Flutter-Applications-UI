...
class RedBag extends StatefulWidget {
  const RedBag({super.key});

  @override
  State<RedBag> createState() => _RedBagState();
}

class _RedBagState extends State<RedBag> with  SingleTickerProviderStateMixin{
