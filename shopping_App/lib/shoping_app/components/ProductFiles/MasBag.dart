...
class MasBag extends StatefulWidget {
  const MasBag({super.key});

  @override
  State<MasBag> createState() => _MasBagState();
}

class _MasBagState extends State<MasBag> with  SingleTickerProviderStateMixin{
