...
class GreenBag extends StatefulWidget {
  const GreenBag({super.key});

  @override
  State<GreenBag> createState() => _GreenBagState();
}

class _GreenBagState extends State<GreenBag> with  SingleTickerProviderStateMixin{
