...
class GoldenBag extends StatefulWidget {
  const GoldenBag({super.key});

  @override
  State<GoldenBag> createState() => _GoldenBagState();
}

class _GoldenBagState extends State<GoldenBag> with  SingleTickerProviderStateMixin{
